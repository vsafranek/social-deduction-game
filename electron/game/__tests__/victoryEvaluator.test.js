...
describe('victoryEvaluator', () => {
  ...
  describe('Helper Functions', () => {
    ...
    test('isHostileNeutral - Maniac is hostile', () => {
      const maniac = createPlayer('1', 'Maniac', true, ['neutral']);
      expect(isHostileNeutral(maniac)).toBe(true);
    });
  ...
  describe('Good Wins - NEW RULES', () => {
    ...
    test('Good does NOT win when evil dead but Maniac alive', () => {
      const players = [
        createPlayer('1', 'Citizen', true, ['good']),
        createPlayer('2', 'Doctor', true, ['good']),
        createPlayer('3', 'Maniac', true, ['neutral', 'solo'], {
          canWinWithTeams: [],
          soloWin: true,
          customRules: [
      ...
      // Game continues - Maniac can kill
    ...
    test('1 good vs 1 Maniac - game continues', () => {
      const players = [
        createPlayer('1', 'Citizen', true, ['good']),
        createPlayer('2', 'Maniac', true, ['neutral', 'solo'], {
          canWinWithTeams: [],
          soloWin: true,
          customRules: []
        }),
      ...
      // Game continues - Maniac can kill good
      expect(result).toBeNull();
    });
  ...
  describe('Solo Wins', () => {
    ...
    test('Maniac solo win when last one standing', () => {
      const maniac = createPlayer('1', 'Maniac', true, ['neutral', 'solo'], {
        canWinWithTeams: [],
        soloWin: true,
        customRules: [
          { type: 'aliveExactly', team: 'neutral', count: 1 },
    ...
    test('Solo win does not trigger if other players alive', () => {
      const players = [
        createPlayer('1', 'Maniac', true, ['neutral', 'solo'], {
          canWinWithTeams: [],
          soloWin: true,
          customRules: []
        }),
